...
================================================================================
  ...
  [★] CONFIRMED SURE-SHOT LAB EXAM QUESTIONS:
      ...
      >> Download Datasets Directly:
         * ${baseUrl}/dataset.csv        -> Student Performance Dataset (105 Rows)
         * ${baseUrl}/datasetknn.csv     -> Healthcare Cardiovascular Risk Dataset (datasetknn.csv)
         * ${baseUrl}/datasetlaplace.csv -> Student Feedback Classification Dataset (datasetlaplace.csv)
         * ${baseUrl}/eda.csv            -> 25 Customers CSV
         * ${baseUrl}/knn.csv            -> 25 Patients CSV
         * ${baseUrl}/feedback.csv       -> 25 Feedback Messages CSV
